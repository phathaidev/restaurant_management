        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="contact-form">
                  ...
                  <form class="forms-sample" action="{{ route("admin.uploadreservation") }}" method="post" enctype="multipart/form-data">
                    @csrf
                      <div class="row">
                        <div class="col-lg-12">
                        ...
                        <div class="col-md-6 col-sm-12">
                          <fieldset>
                            <select value="number-guests" name="numberguest" id="number-guests">
